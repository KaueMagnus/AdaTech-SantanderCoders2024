...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            System.out.print("Escolha uma opçáo: ");
            ...
            switch (opcao) {
                ...
                case 2:
                    ...
                    break;
                case 3:
                    System.out.print("Digite a posiçáo do item a ser removido: ");
                ...
                case 4:
                    ...
                    break;
                default:
                    System.out.println("Opçáo inválida. Por favor, escolha novamente.");
            }
        } while (opcao != 4);
